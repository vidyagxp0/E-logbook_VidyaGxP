...
function Sidebar() {
  ...
  return (
    <aside className="flex flex-col h-full">
      ...
      <div
        className={`inner-block bg-gray-800 text-white h-full p-4 transition-transform transform ${
        ...
        <Each
          ...
          render={(item) => (
            <div className="sidebar-link mb-2" key={item.id}>
              {item.hasChild ? (
                <div
                  className="link-head flex justify-between items-center cursor-pointer"
                  ...
                  {item.child ? (
                    <Each
                      ...
                      render={(child) => (
                        <NavLink
                          to={child.link}
                          className="sidebar-subLink flex items-center text-sm mb-1"
                        >
