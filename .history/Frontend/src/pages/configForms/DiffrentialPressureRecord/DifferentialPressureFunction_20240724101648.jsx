...
export default function DifferentialPressure() {
  ...
  const handleInputChange1 = (e) => {
    ...
    setDifferentialPRecord({ [name]: value });
  };

  const handleReviewerFileChange = (e) => {
    setDifferentialPRecord({ reviewerAttachment: e.target.files[0] });
  };
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              ...
                              id={`differential-pressure-input-${index}`}
                              onChange={(e) => {
                                const newData = [...allTableData];
                          ...
                          <td style={{ width: "250px" }}>
                            <div className="d-flex">
                              <input
                                ...
                                className="input-field"
                                id={`supporting-docs-input-${index}`}
                              />
