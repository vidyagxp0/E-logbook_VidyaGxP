          ...
          >
            <form onSubmit={handleSubmit} style={{}}>
              ...
              <div className="group-input" style={{ margin: "15px" }}>
                <label htmlFor="name" style={{ color: "#207ec" }}>
                  Name
                </label>
                <input
                  type="text"
              ...
              <div className="group-input" style={{ margin: "15px" }}>
                <label htmlFor="email" style={{ color: "#207ec" }}>
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="group-input" style={{ margin: "15px" }}>
                <label style={{ color: "#207ec" }}>Age</label>
                <input
                  type="number"
                  name="age"
                  id="age"
              ...
              <div className="group-input" style={{ margin: "15px" }}>
                <label htmlFor="gender" style={{ color: "#207ec" }}>
                  Gender
                </label>
                <select
                  name="gender"
              ...
              <div className="group-input" style={{ margin: "15px" }}>
                <label htmlFor="password" style={{ color: "#207ec" }}>
                  Password
                </label>
                <input
                  type="password"
              ...
              <div className="group-input" style={{ margin: "15px" }}>
                <label htmlFor="profilePic" style={{ color: "#207ec" }}>
                  Profile Picture
                </label>
                <input
                  type="file"
              ...
              <div className="" style={{ margin: "15px" }}>
                <label htmlFor="roles" style={{ color: "#207ec" }}>
                  Roles
                </label>
                <Select
                  name="selectedRoles"
