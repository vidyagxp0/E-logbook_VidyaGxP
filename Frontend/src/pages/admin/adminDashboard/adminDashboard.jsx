...
function AdminDashboard() {
  ...
  const resetPassword = () => {
    ...
    axios
      .post(
        "https://elog-api.mydemosoftware.com/user/reset-password",
        {
  ...
  useEffect(() => {
    ...
    const url = "https://elog-api.mydemosoftware.com/user/get-all-users"; // Assuming the endpoint is corrected to "/user/get-all-users"
    axios
      .get(url, {
        headers: {
  ...
  const handleDelete = () => {
    const config = {
      method: "delete",
      url: `https://elog-api.mydemosoftware.com/user/delete-user/${selectedUser.user_id}`,
      headers: {
        Authorization: `Bearer ${localStorage.getItem("admin-token")}`,
      },
    };
  ...
  const openPermissionsModal = (user) => {
    ...
    axios
      .get(
        `https://elog-api.mydemosoftware.com/user/get-user-permissions/${user.user_id}`,
        {
          headers: {
