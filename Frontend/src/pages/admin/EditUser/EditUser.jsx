...
function EditUser() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://elog-api.mydemosoftware.com/user/get-a-user/${location.state.id}`,
        {
          headers: {
    ...
    axios
      .get("https://elog-api.mydemosoftware.com/user/get-all-rolegroups")
      .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        `https://elog-api.mydemosoftware.com/user/edit-user/${location.state.id}`,
        resultObj,
        {
          headers: myHeaders,
        }
