...
export default function EquipmentUsage() {
 ...
 useEffect(() => {
  // Step 1: Check if site_id is available
  const siteId = location.state?.site_id || localStorage.getItem("site_id");
  
  if (!siteId) {
    console.error("Site ID is missing! Cannot fetch reviewers/approvers.");
    return; // Stop execution if site_id is not available
  }

  const config = {
    method: "post",
    url: "http://localhost:1000/equipment-usage/get-user-roleGroups",
    headers: {
  ...
  const handlePopupSubmit = (credentials) => {
    if (
      equipmentUsageRecord.site_id === null ||
      equipmentUsageRecord.approver_id === null ||
      equipmentUsageRecord.reviewer_id === null
    ) {
      toast.error(
    ...
    // if (equipmentUsageRecord.initiatorComment === "") {
    //   toast.error("Please provide an initiator comment!");
    //   return;
    // }

    // if (equipmentUsageRecord.description === "") {
    //   toast.error("Please provide a short description!");
    //   return;
    // }
    if (
      equipmentUsageRecord?.FormRecordsArray?.some(
    ...
    equipmentUsageRecord.email = credentials?.email;
    equipmentUsageRecord.password = credentials?.password;
    equipmentUsageRecord.initiatorDeclaration = credentials?.declaration;

    axios
      .post(
        "http://localhost:1000/equipment-usage/post",
  ...
  const [equipmentUsageRecord, setEquipmentUsageRecord] = useReducer(
    (prev, next) => ({
      ...prev,
      ...next,
    }),
  ...
  useEffect(() => {
    setEquipmentUsageRecord({ FormRecordsArray: allTableData });
  }, [allTableData]);
  ...
  console.log("Form Main Data:", equipmentUsageRecord);
        ...
        <div id="config-form-document-pages" className="min-w-full">
          ...
          <div className="document-form">
            <div className="details-form-data">
              ...
              <div className="sub-head-2">Equipment Usage Records</div>
                ...
                <>
                  ...
                  <div className="group-input">
                    ...
                    <div>
                      <input
                        ...
                        value={User?.name}
                        onChange={(e) =>
                          setEquipmentUsageRecord({ initiator: e.target.value })
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="group-input">
                    ...
                    <div>
                      {/* <input
                        type="text"
                        value={equipmentUsageRecord.description}
                        onChange={(e) =>
                          setEquipmentUsageRecord({
                      ...
                      /> */}
                      <TinyEditor
                        editorContent={equipmentUsageRecord.description}
                  ...
                  <div className="group-input">
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) =>
                          setEquipmentUsageRecord({ status: e.target.value })
                        }
                      />
                    </div>
                  </div>
              ...
              {isSelectedDetails === true ? (
                ...
                <div className="group-input">
                    ...
                    <label className="color-label">Equipment Name </label>
                    <div>
                      <input
                        type="text"
                        value={equipmentUsageRecord.equipment_name || ""}
                          onChange={(e) =>
                         
                            setEquipmentUsageRecord({ equipment_name: e.target.value })
                          }
                      />
                    </div>
                </div>
                ...
                <div className="group-input">
                    ...
                    <label className="color-label">Equipment ID. </label>
                    <div>
                      <input
                        type="text"
                        value={equipmentUsageRecord.equipment_id || ""}
                          onChange={(e) =>
                         
                            setEquipmentUsageRecord({ equipment_id: e.target.value })
                          }
                ...
                <div className="group-input">
                    ...
                    <div>
                      <input
                        type="text"
                        value={equipmentUsageRecord.area_name || ""}
                          onChange={(e) =>
                         
                            setEquipmentUsageRecord({ area_name: e.target.value })
                          }
                  ...
                  <div className="group-input">
                    ...
                    <select
                      ...
                      name="assign_to"
                      value={equipmentUsageRecord.department}
                      onChange={(e) =>
                        setEquipmentUsageRecord({
                  ...
                  <div className="group-input">
                    ...
                    {/* <div className="instruction mb-0">&nbsp;</div> */}
                    <select
                      className="form-control"
                      name="assign_to"
                      value={equipmentUsageRecord.compression_area}
                      onChange={(e) =>
                        setEquipmentUsageRecord({
                  ...
                  <div className="group-input">
                    ...
                    <input
                      type="number"
                      // className={`${
                      //   equipmentUsageRecord.limit < 23
                      //     ? "limit"
                      //     : equipmentUsageRecord.limit > 27
                      //     ? "limit"
                      //     : ""
                      // }`}
                      value={equipmentUsageRecord.limit}
                      onChange={(e) =>
                        setEquipmentUsageRecord({ limit: e.target.value })
                      }
                    />
                  </div>
                  <div className="form-flex">
                    <div className="group-input">
                      ...
                      <div>
                        <select
                          value={equipmentUsageRecord.reviewer_id}
                          onChange={(e) => {
                            setEquipmentUsageRecord({
                    ...
                    <div className="group-input">
                      ...
                      <div>
                        <select
                          value={equipmentUsageRecord.approver_id}
                          onChange={(e) => {
                            setEquipmentUsageRecord({
                  ...
                  <div className="group-input ">
                    ...
                    <div>
                      <textarea
                        ...
                        name="additionalInfo"
                        disabled
                        value={equipmentUsageRecord.additionalInfo}
                        onChange={(e) => {
                          setEquipmentUsageRecord({
