...
export default function DiffrentialPressure() {
 ...
 useEffect(() => {
  setDifferentialPRecord((prev) => ({
    ...prev,
    FormRecordsArray: allTableData,
  }));
}, [allTableData]);
                    ...
                    <div className="gap-6 mt-6 mb-6">
                      ...
                      <div className="flex flex-col mb-4">
                        ...
                        <input
                          ...
                          value={differentialPRecord.area_name || ""}
                          onChange={(e) =>
                            
                            setDifferentialPRecord({ area_name: e.target.value })
                          }
                      ...
                      <div className="flex flex-col mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            ...
                            setDifferentialPRecord({ acceptance_criteria: e.target.value })
                          }
                        />
                      </div>
                      ...
                      <div className="flex flex-col mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            ...
                            setDifferentialPRecord({ differential_pressure: e.target.value })
                          }
                        />
                      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <input
                          type="text"
                          className="border border-gray-500 rounded-md p-2 w-full max-w-full"
                          value={differentialPRecord.instrument_id_no || ""}
                          onChange={(e) =>
                         
                            setDifferentialPRecord({ instrument_id_no: e.target.value })
                          }
                        />
                      </div>
                    </div>
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              ...
                              onChange={(e) => {
                                const newData = [...allTableData];
                                newData[index].remarks = e.target.checked;
                                setAllTableData(newData);
                              }}
                            />
