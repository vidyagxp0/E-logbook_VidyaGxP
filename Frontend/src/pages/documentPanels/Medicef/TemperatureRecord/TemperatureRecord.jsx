...
export default function TemperatureRecord() {
 ...
 useEffect(() => {
  ...
  console.log("Form Main Data:", tempratureRecord);
        ...
        <div id="config-form-document-pages" className="min-w-full">
          ...
          <div className="document-form">
            <div className="details-form-data">
              ...
              <div className="sub-head-2">Temperature and Relative Humidity Record
</div>
              ...
              {isSelectedDetails === true ? (
                ...
                <div className="group-input">
                    ...
                    <div>
                      <input
                        type="text"
                        value={tempratureRecord.area_name || ""}
                          onChange={(e) =>
                         
                            setTempratureRecord({ area_name: e.target.value })
                          }
                ...
                <div className="group-input">
                    ...
                    <div>
                      <input
                        type="text"
                        value={tempratureRecord.room_id || ""}
                          onChange={(e) =>
                         
                            setTempratureRecord({ room_id: e.target.value })
                          }
                ...
                <div className="group-input">
                    ...
                    <div>
                      <input
                        type="text"
                        value={tempratureRecord.instrument_id || ""}
                          onChange={(e) =>
                         
                            setTempratureRecord({ instrument_id: e.target.value })
                          }
                    ...
                    <div>
                      <input
                        ...
                        value={tempratureRecord.acceptance_temperature || ""}
                          onChange={(e) =>
                            setTempratureRecord({ acceptance_temperature: e.target.value })
                          }
                      ...
                      <input
                        ...
                        value={tempratureRecord.relative_humidity_criteria || ""}
                          onChange={(e) =>
                            ...
                            setTempratureRecord({ relative_humidity_criteria: e.target.value })
                          }
