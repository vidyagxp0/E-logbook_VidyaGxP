...
const UvWlTransilluminatorPanel = () => {
  ...
  const generateReport = async () => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:1000/uv-wl-transi/chat-pdf/${formId}`,
        {
                    ...
                    <div className="group-input">
                      ...
                      <div>
                        <input
                          type="text"
                          name="reviewer"
                          value={editData?.reviewerss11?.name}
                          readOnly
                        />
                      </div>
                    </div>
                    ...
                    <div className="group-input">
                      ...
                      <div>
                        <input
                          type="text"
                          name="approver"
                          value={editData?.approverss11?.name}
                          readOnly
                        />
                      </div>
                    </div>
...
export default UvWlTransilluminatorPanel;
