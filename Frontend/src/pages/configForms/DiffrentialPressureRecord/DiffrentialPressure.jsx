...
export default function DiffrentialPressure() {
  ...
  useEffect(() => {
    const config = {
      method: "post",
      url: "http://195.35.6.197:1000/differential-pressure/get-user-roleGroups",
      headers: {
  ...
  useEffect(() => {
    const requestOptions = {
      method: "GET",
      url: `http://195.35.6.197:1000/user/get-a-user/${loggedInUser?.userId}`, // Ensure you use the correct URL format including 'http://'
  ...
  const handlePopupSubmit = (credentials) => {
    ...
    axios
      .post(
        "http://195.35.6.197:1000/differential-pressure/post-differential-pressure",
        differentialPRecord,
        config
      )
      .then(() => {
