        ...
        <div id="config-form-document-pages" className="min-w-full">
          ...
          <div className="document-form">
            <div className="details-form-data">
              ...
              <div className="sub-head-2"> Fogging Solution</div>
              ...
              {isSelectedGeneral === true ? (
                <>
                  <div className="group-input">
                    <label className="color-label">Prepared by</label>
                    <div>
                      <input
                        type="text"
                        value={User?.name}
                  ...
                  <table>
                    <thead>
                      <tr>
                        <th>S no.</th>
                        <th>Date</th>
                        <th>Name of area & No.</th>
                        <th>AHU No.</th>
                        <th>AHU off date & time</th>
                        <th>Volume of area (ft.³)</th>
                        <th>Fogging solution qty. (ml)</th>
...
export default FoggingSolution;
