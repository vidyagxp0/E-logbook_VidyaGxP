...
function HeaderTop() {
  ...
  const modalData = {
    logo: "/vidyalogo21.png", // Replace with your logo
    title: "VidyaGxP",
    details: [
      { label: "Version", value: "2.1.1" },
      { label: "Build #", value: "2" },
      { label: "Date", value: "April 23, 2023" },
      { label: "Licensed to", value: "Lark Labs" },
        ...
        {modalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg p-6 w-[80%] max-w-7xl">
              <h2 className="text-2xl  bg-[#0c5fc6] font-semibold text-white py-2 px-2 mb-4">
                Help Desk
              </h2>
              <table className="table-auto w-full border-collapse border border-gray-300 ">
                <thead className="bg-slate-500 sticky top-0 text-white">
                  <tr>
                    <th className="border border-gray-300 w-[5%] py-2">
                      S. No.
                    </th>
