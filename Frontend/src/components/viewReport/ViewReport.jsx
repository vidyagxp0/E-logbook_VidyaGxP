...
const ViewReport = () => {
  ...
  const pdfUrl = `https://elog-api.mydemosoftware.com/public/${elogIdValue}`;
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        "https://elog-api.mydemosoftware.com/user/get-all-users",
        {
          headers: {
  ...
  useEffect(() => {
   ...
   const handleSendEmail = async () => {
    ...
    const emailPromise = axios.post(
      `https://elog-api.mydemosoftware.com/differential-pressure/send-report-on-mail/${elogIdValue}`,
      emailPayload,
      {
        headers: {
