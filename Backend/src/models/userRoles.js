...
RoleGroup.hasMany(UserRole, { foreignKey: "roleGroup_id" });
  ...
  const rolesArray1 = [
    { label: "Shilpa-Fogging Solution-Initiator", value: 1 },

  ];
  const rolesArray2 = [
    { label: "Shilpa-Fogging Solution-Reviewer", value: 2 },
  ];
  const rolesArray3 = [
    { label: "Shilpa-Fogging Solution-approver", value: 3 },
  ];
  const rolesArray4 = [
    { label: "Shilpa-Fogging Solution-Fullpermission", value: 5 },
  ];
  // const rolesArray1 = [
