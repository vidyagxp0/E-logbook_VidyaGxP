...
RoleGroup.hasMany(UserRole, { foreignKey: "roleGroup_id" });
  ...
  const rolesArray1 = [
    { label: "Biologics-Analytical Balance-Initiator", value: 1 },
    { label: "Biologics-Karl Fischer-Initiator", value: 2 },
    { label: "Biologics-HPLC-Initiator", value: 3 },
    { label: "Biologics-pH Meter Op/Cal-Initiator", value: 4 },
    { label: "Biologics-UV Vis Calib-Initiator", value: 5 },
    { label: "Biologics-SDS PAGE-Initiator", value: 6 },
    { label: "Biologics-Gel Doc iGene-Initiator", value: 7 },
    { label: "Biologics-UV/White Light Transilluminator-Initiator", value: 8 },
    { label: "Biologics-VO Calibration-Initiator", value: 9 },
    { label: "AR&D-Analytical Balance-Initiator", value: 10 },
    { label: "AR&D-Karl Fischer-Initiator", value: 11 },
    { label: "AR&D-HPLC-Initiator", value: 12 },
    { label: "AR&D-pH Meter Op/Cal-Initiator", value: 13 },
    { label: "AR&D-UV Vis Calib-Initiator", value: 14 },
    { label: "AR&D-SDS PAGE-Initiator", value: 15 },
    { label: "AR&D-Gel Doc iGene-Initiator", value: 16 },
    { label: "AR&D-UV/White Light Transilluminator-Initiator", value: 17 },
    { label: "AR&D-VO Calibration-Initiator", value: 18 },
  ...
  const rolesArray2 = [
    { label: "Biologics-Analytical Balance-Reviewer", value: 19 },
    { label: "Biologics-Karl Fischer-Reviewer", value: 20 },
    { label: "Biologics-HPLC-Reviewer", value: 21 },
    { label: "Biologics-pH Meter Op/Cal-Reviewer", value: 22 },
    { label: "Biologics-UV Vis Calib-Reviewer", value: 23 },
    { label: "Biologics-SDS PAGE-Reviewer", value: 24 },
    { label: "Biologics-Gel Doc iGene-Reviewer", value: 25 },
    { label: "Biologics-UV/White Light Transilluminator-Reviewer", value: 26 },
    { label: "Biologics-VO Calibration-Reviewer", value: 27 },
    { label: "AR&D-Analytical Balance-Reviewer", value: 28 },
    { label: "AR&D-Karl Fischer-Reviewer", value: 29 },
    { label: "AR&D-HPLC-Reviewer", value: 30 },
    { label: "AR&D-pH Meter Op/Cal-Reviewer", value: 31 },
    { label: "AR&D-UV Vis Calib-Reviewer", value: 32 },
    { label: "AR&D-SDS PAGE-Reviewer", value: 33 },
    { label: "AR&D-Gel Doc iGene-Reviewer", value: 34 },
    { label: "AR&D-UV/White Light Transilluminator-Reviewer", value: 35 },
    { label: "AR&D-VO Calibration-Reviewer", value: 36 },
    // { label: "EU-Differential Pressure Record-Reviewer", value: 37 },
    // { label: "EU-Temperature Records-Reviewer", value: 38 },
    // { label: "EU-Loaded Quantity-Reviewer", value: 39 },
  ...
  const rolesArray3 = [
    { label: "Biologics-Analytical Balance-Approver", value: 37 },
    { label: "Biologics-Karl Fischer-Approver", value: 38 },
    { label: "Biologics-HPLC-Approver", value: 39 },
    { label: "Biologics-pH Meter Op/Cal-Approver", value: 40 },
    { label: "Biologics-UV Vis Calib-Approver", value: 41 },
    { label: "Biologics-SDS PAGE-Approver", value: 42 },
    { label: "Biologics-Gel Doc iGene-Approver", value: 43 },
    { label: "Biologics-UV/White Light Transilluminator-Approver", value: 44 },
    { label: "Biologics-VO Calibration-Approver", value: 45 },
    { label: "AR&D-Analytical Balance-Approver", value: 46 },
    { label: "AR&D-Karl Fischer-Approver", value: 47 },
    { label: "AR&D-HPLC-Approver", value: 48 },
    { label: "AR&D-pH Meter Op/Cal-Approver", value: 49 },
    { label: "AR&D-UV Vis Calib-Approver", value: 50 },
    { label: "AR&D-SDS PAGE-Approver", value: 51 },
    { label: "AR&D-Gel Doc iGene-Approver", value: 52 },
    { label: "AR&D-UV/White Light Transilluminator-Approver", value: 53 },
    { label: "AR&D-VO Calibration-Approver", value: 54 },
  ...
  const rolesArray4 = [
    { label: "Biologics-Analytical Balance-Fullpermission", value: 73 },
    { label: "Biologics-Karl Fischer-Fullpermission", value: 74 },
    { label: "Biologics-HPLC-Fullpermission", value: 75 },
    { label: "Biologics-pH Meter Op/Cal-Fullpermission", value: 76 },
    { label: "Biologics-UV Vis Calib-Fullpermission", value: 77 },
    { label: "Biologics-SDS PAGE-Fullpermission", value: 78 },
    { label: "Biologics-Gel Doc iGene-Fullpermission", value: 79 },
    { label: "Biologics-UV/White Light Transilluminator-Fullpermission", value: 80 },
    { label: "Biologics-VO Calibration-Fullpermission", value: 81 },
    { label: "AR&D-Analytical Balance-Fullpermission", value: 82 },
    { label: "AR&D-Karl Fischer-Fullpermission", value: 83 },
    { label: "AR&D-HPLC-Fullpermission", value: 84 },
    { label: "AR&D-pH Meter Op/Cal-Fullpermission", value: 85 },
    { label: "AR&D-UV Vis Calib-Fullpermission", value: 86 },
    { label: "AR&D-SDS PAGE-Fullpermission", value: 87 },
    { label: "AR&D-Gel Doc iGene-Fullpermission", value: 88 },
    { label: "AR&D-UV/White Light Transilluminator-Fullpermission", value: 89 },
    { label: "AR&D-VO Calibration-Fullpermission", value: 90 },
