...
RoleGroup.hasMany(UserRole, { foreignKey: "roleGroup_id" });
  ...
  const rolesArray1 = [
    ...
    { label: "AR&D-Analytical Balance-Initiator", value: 5 },
    { label: "AR&D-Karl Fischer-Initiator", value: 6 },
    { label: "AR&D-HPLC-Initiator", value: 7 },
    { label: "AR&D-pH Meter Op/Cal-Initiator", value: 8 },
  ...
  const rolesArray2 = [
    { label: "Biologics-Analytical Balance-Reviewer", value: 9 },
    { label: "Biologics-Karl Fischer-Reviewer", value: 10 },
    { label: "Biologics-HPLC-Reviewer", value: 11 },
    { label: "Biologics-pH Meter Op/Cal-Reviewer", value: 12 },
    ...
    { label: "AR&D-Analytical Balance-Reviewer", value: 13 },
    { label: "AR&D-Karl Fischer-Reviewer", value: 14 },
    { label: "AR&D-HPLC-Reviewer", value: 15 },
    { label: "AR&D-pH Meter Op/Cal-Reviewer", value: 16 },
  ...
  const rolesArray3 = [
    { label: "Biologics-Analytical Balance-Approver", value: 17 },
    { label: "Biologics-Karl Fischer-Approver", value: 18 },
    { label: "Biologics-HPLC-Approver", value: 19 },
    { label: "Biologics-pH Meter Op/Cal-Approver", value: 20 },
    ...
    { label: "AR&D-Analytical Balance-Approver", value: 21 },
    { label: "AR&D-Karl Fischer-Approver", value: 22 },
    { label: "AR&D-HPLC-Approver", value: 23 },
    { label: "AR&D-pH Meter Op/Cal-Approver", value: 24 },
  ...
  const rolesArray4 = [
    { label: "Biologics-Analytical Balance-Fullpermission", value: 33 },
    { label: "Biologics-Karl Fischer-Fullpermission", value: 34 },
    { label: "Biologics-HPLC-Fullpermission", value: 35 },
    { label: "Biologics-pH Meter Op/Cal-Fullpermission", value: 36 },
    ...
    { label: "AR&D-Analytical Balance-Fullpermission", value: 37 },
    { label: "AR&D-Karl Fischer-Fullpermission", value: 38 },
    { label: "AR&D-HPLC-Fullpermission", value: 39 },
    { label: "AR&D-pH Meter Op/Cal-Fullpermission", value: 40 },
