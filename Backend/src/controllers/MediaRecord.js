...
const MRApproverAssignment = require("../models/MRApproverAssignment");
const MRReviewerAssignment = require("../models/MRReviewerAssignment");
...
exports.InsertMediaRecord = async (req, res) => {
  ...
  try {
    ...
    await MRReviewerAssignment.bulkCreate(reviewerAssignments, { transaction });
    ...
    await MRApproverAssignment.bulkCreate(approverAssignments, { transaction });
...
exports.GetAllMediaRecord = async (req, res) => {
  try {
    const result = await MediaRecordProcessForm.findAll({
      include: [
        {
          model: MediaRecord,
        },
