...
{isSelectedGeneral === true ? <>   <div className="group-input">
                ...
                <div>
                  <input type="text" value={e.initiator} onChange={(e) => setAreaAndEquiment({ initiator: e.target.value })} />
                </div>
              </div>
                ...
                <div className="group-input">
                  ...
                  <div>
                    <input type="text" value={e.shortDescription} onChange={(e) => setAreaAndEquiment({ shortDescription: e.target.value })} />
                  </div>
                </div>
                ...
                <div className="group-input">
                  ...
                  <div>
                    <input type="text" value={e.description} onChange={(e) => setAreaAndEquiment({ description: e.target.value })} />
                  </div>
                </div>
                ...
                <div className="group-input">
                  ...
                  <div>
                    <input type="text" value={e.status} onChange={(e) => setAreaAndEquiment({ status: e.target.value })} />
                  </div>
                </div></> : null}
              ...
              {isSelectedDetails === true ? <> <div className="group-input">
                ...
                <div>
                  <input type="text" value={e.area} onChange={(e) => setAreaAndEquiment({ area: e.target.value })} />
                </div>
              </div>
                <div className="group-input">
                  <label className="color-label">Area Code </label>
                  <div>
                    <input type="text" value={e.areaCode} onChange={(e) => setAreaAndEquiment({ areaCode: e.target.value })} />
                  </div>
                </div>
