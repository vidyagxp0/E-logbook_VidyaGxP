                ...
                <div className="group-input">
                  ...
                  <div>
                    <input
                      ...
                      onChange={(e) => setTemperatureRecords({ initiator: e.target.value })}
                    />
                  </div>
                </div>
                ...
                <div className="group-input">
                  ...
                  <div>
                    <input
                      ...
                      onChange={(e) => setTemperatureRecords({ status: e.target.value })}
                    />
                  </div>
                </div>
              </>
              ...
              <>
                ...
                <div className="group-input">
                  ...
                  <input
                    ...
                    onChange={(e) => setTemperatureRecords({ limit: e.target.value })}
                  />
                </div>
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <input
                            ...
                            value={item.limit}
                            className={`${
                              item.limit < 23 ? "limit" : item.limit > 27 ? "limit" : ""
                            }`}
                            onChange={(e) => {
                              const newData = [...allTableData];
                        ...
                        <td>
                          ...
                          {item.limit !== "" && (item.limit < 23 || item.limit > 27) && (
                            <button
